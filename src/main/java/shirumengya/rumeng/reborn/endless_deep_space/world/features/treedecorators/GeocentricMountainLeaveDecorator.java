...
public class GeocentricMountainLeaveDecorator extends LeaveVineDecorator {
	public static final GeocentricMountainLeaveDecorator INSTANCE = new GeocentricMountainLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		ForgeRegistries.TREE_DECORATOR_TYPES.register("geocentric_mountain_tree_leave_decorator", tdt);
	}

	public GeocentricMountainLeaveDecorator() {
		super(0.25f);
	}
