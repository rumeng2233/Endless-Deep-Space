...
public class NihilityBiomeFruitDecorator extends CocoaDecorator {
	public static final NihilityBiomeFruitDecorator INSTANCE = new NihilityBiomeFruitDecorator();
	public static com.mojang.serialization.Codec<NihilityBiomeFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		ForgeRegistries.TREE_DECORATOR_TYPES.register("nihility_biome_tree_fruit_decorator", tdt);
	}

	public NihilityBiomeFruitDecorator() {
		super(0.2f);
	}
