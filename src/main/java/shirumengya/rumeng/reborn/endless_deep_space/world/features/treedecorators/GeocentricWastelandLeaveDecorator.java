...
public class GeocentricWastelandLeaveDecorator extends LeaveVineDecorator {
	public static final GeocentricWastelandLeaveDecorator INSTANCE = new GeocentricWastelandLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		ForgeRegistries.TREE_DECORATOR_TYPES.register("geocentric_wasteland_tree_leave_decorator", tdt);
	}

	public GeocentricWastelandLeaveDecorator() {
		super(0.25f);
	}
