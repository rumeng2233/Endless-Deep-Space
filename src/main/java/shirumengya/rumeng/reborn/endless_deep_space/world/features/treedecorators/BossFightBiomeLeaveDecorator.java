...
public class BossFightBiomeLeaveDecorator extends LeaveVineDecorator {
	public static final BossFightBiomeLeaveDecorator INSTANCE = new BossFightBiomeLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		ForgeRegistries.TREE_DECORATOR_TYPES.register("boss_fight_biome_tree_leave_decorator", tdt);
	}

	public BossFightBiomeLeaveDecorator() {
		super(0.25f);
	}
