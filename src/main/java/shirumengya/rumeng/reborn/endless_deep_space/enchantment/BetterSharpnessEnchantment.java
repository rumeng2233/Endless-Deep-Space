...
public class BetterSharpnessEnchantment extends Enchantment {
   ...
   int p_44629_;
	...
	public BetterSharpnessEnchantment(EquipmentSlot... slots) {
   ...
   public float getDamageBonus(int p_44635_, MobType p_44636_) {
      if (this.type == 0) {
         return 4.0F + (float)Math.max(0, p_44635_ - 1) * 2.5F;
   ...
   public boolean checkCompatibility(Enchantment p_44644_) {
      return !(p_44644_ instanceof BetterSharpnessEnchantment);
   }
