...
public class ExplosionDestroyNullProcedure {
	public static void execute(LevelAccessor world, CommandContext<CommandSourceStack> arguments) {
		if (BoolArgumentType.getBool(arguments, "fire") == true) {
			if (world instanceof Level _level && !_level.isClientSide())
				...
				}.getZ()), (float) DoubleArgumentType.getDouble(arguments, "level"), true, Explosion.BlockInteraction.DESTROY);
		} else {
			if (world instanceof Level _level && !_level.isClientSide())
				_level.explode(null, (new Object() {
					public double getX() {
				...
				}.getZ()), (float) DoubleArgumentType.getDouble(arguments, "level"), Explosion.BlockInteraction.DESTROY);
		}
	}
}
