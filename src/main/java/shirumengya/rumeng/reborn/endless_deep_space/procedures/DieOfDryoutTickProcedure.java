...
public class DieOfDryoutTickProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, Entity entity, DamageSource source) {
		if (entity == null)
			return;
		if (source == DamageSource.DRY_OUT) {
			if (entity instanceof ServerPlayer _player) {
				Advancement _adv = _player.server.getAdvancements().getAdvancement(new ResourceLocation("endless_deep_space:die_of_dryout"));
