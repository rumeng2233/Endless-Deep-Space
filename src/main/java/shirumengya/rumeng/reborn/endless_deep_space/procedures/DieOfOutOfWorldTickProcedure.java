...
public class DieOfOutOfWorldTickProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, Entity entity, DamageSource source) {
		...
		if (source == DamageSource.OUT_OF_WORLD) {
			if (entity instanceof ServerPlayer _player) {
				Advancement _adv = _player.server.getAdvancements().getAdvancement(new ResourceLocation("endless_deep_space:die_of_out_of_world"));
