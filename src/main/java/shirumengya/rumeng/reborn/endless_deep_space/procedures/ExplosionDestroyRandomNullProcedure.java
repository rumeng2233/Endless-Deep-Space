...
public class ExplosionDestroyRandomNullProcedure {
			...
			if (world instanceof Level _level && !_level.isClientSide())
				_level.explode(null, (new Object() {
					...
					public double getZ() {
						...
						DoubleArgumentType.getDouble(arguments, "max")), true, Explosion.BlockInteraction.DESTROY);
		} else {
			if (world instanceof Level _level && !_level.isClientSide())
				_level.explode(null, (new Object() {
					public double getX() {
					...
					public double getZ() {
						...
						DoubleArgumentType.getDouble(arguments, "max")), Explosion.BlockInteraction.DESTROY);
		}
	}
}
