...
=======
	...
	public static final RegistryObject<Item> THE_VOID_CUBE_SPAWN_EGG = REGISTRY.register("the_void_cube_spawn_egg",
			() -> new ForgeSpawnEggItem(EndlessDeepSpaceModEntities.THE_VOID_CUBE, -16777216, -13621667, new Item.Properties().tab(EndlessDeepSpaceModTabs.TAB_ENDLESS_DEEP_SPACE_TAP)));
	public static final RegistryObject<Item> SUPER_BOMB = block(EndlessDeepSpaceModBlocks.SUPER_BOMB, EndlessDeepSpaceModTabs.TAB_ENDLESS_DEEP_SPACE_TAP);
	public static final RegistryObject<Item> MINI_SUPER_BOMB = block(EndlessDeepSpaceModBlocks.MINI_SUPER_BOMB, EndlessDeepSpaceModTabs.TAB_ENDLESS_DEEP_SPACE_TAP);
	public static final RegistryObject<Item> MINIMALITY_SUPER_BOMB = block(EndlessDeepSpaceModBlocks.MINIMALITY_SUPER_BOMB, EndlessDeepSpaceModTabs.TAB_ENDLESS_DEEP_SPACE_TAP);
	public static final RegistryObject<Item> THUNDER_DROWNED_SPAWN_EGG = REGISTRY.register("thunder_drowned_spawn_egg",
			() -> new ForgeSpawnEggItem(EndlessDeepSpaceModEntities.THUNDER_DROWNED, -16711681, -13382401, new Item.Properties().tab(EndlessDeepSpaceModTabs.TAB_ENDLESS_DEEP_SPACE_TAP)));
>>>>>>> Stashed changes
