...
import shirumengya.rumeng.reborn.endless_deep_space.entity.GhastlierEntity;
...
public class GhastlierRenderer extends MobRenderer<GhastlierEntity, GhastModel<GhastlierEntity>> {
...
private static final RenderType BEAM_RENDER_TYPE = RenderType.entityCutoutNoCull(GUARDIAN_BEAM_LOCATION);
	...
	public GhastlierRenderer(EntityRendererProvider.Context context) {
		super(context, new GhastModel(context.bakeLayer(ModelLayers.GHAST)), 0.5f);
	}

	@Override
	public ResourceLocation getTextureLocation(GhastlierEntity entity) {
		return GHAST_LOCATION;
	}

	@Override
	protected void scale(GhastlierEntity p_114757_, PoseStack p_114758_, float p_114759_) {
   ...
   public void render(GhastlierEntity p_114829_, float p_114830_, float p_114831_, PoseStack p_114832_, MultiBufferSource p_114833_, int p_114834_) {
      super.render(p_114829_, p_114830_, p_114831_, p_114832_, p_114833_, p_114834_);
      LivingEntity livingentity = p_114829_.getTarget();
