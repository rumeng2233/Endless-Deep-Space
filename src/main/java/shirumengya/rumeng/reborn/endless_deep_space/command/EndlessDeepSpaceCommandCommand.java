...
public class EndlessDeepSpaceCommandCommand {
	...
	public static void registerCommand(RegisterCommandsEvent event) {
		event.getDispatcher()
				.register(
						Commands.literal("endless_deep_space").requires(s -> s.hasPermission(2))
								.then(Commands.literal("endless_deep_space")
										.then(Commands.literal("gui").then(Commands.literal("toast")
												.then(Commands.literal("EndlessDeepSpaceCommonToast").then(Commands.argument("player", EntityArgument.players())
														.then(Commands.argument("item", ItemArgument.item(event.getBuildContext())).then(
																Commands.argument("title", StringArgumentType.string()).then(Commands.argument("description", StringArgumentType.string()).then(Commands.argument("time", DoubleArgumentType.doubleArg())
																		.then(Commands.argument("titlecolor", DoubleArgumentType.doubleArg()).then(Commands.argument("descriptioncolor", DoubleArgumentType.doubleArg()).executes(arguments -> {
																			...
																			EndlessDeepSpaceCommonToastOpenCommandProcedure.execute(x, y, z, arguments);
																			return 0;
																		})))))))))))
										.then(Commands.literal("entity").then(Commands.literal("entity").then(Commands.literal("boss").then(Commands.literal("undead").then(Commands.literal("Witherest")
												.then(Commands.argument("targets", EntityArgument.entities()).then(Commands.literal("add").then(Commands.argument("assault_value", DoubleArgumentType.doubleArg()).executes(arguments -> {
													ServerLevel world = arguments.getSource().getLevel();
													double x = arguments.getSource().getPosition().x();
													double y = arguments.getSource().getPosition().y();
													double z = arguments.getSource().getPosition().z();
										...
										.then(Commands.literal("world").then(Commands.literal("structure").then(Commands.literal("minecraft")
												.then(Commands.literal("beacon").then(Commands.literal("one").then(Commands.literal("diamond_block").then(Commands.argument("pos", BlockPosArgument.blockPos()).executes(arguments -> {
													ServerLevel world = arguments.getSource().getLevel();
													double x = arguments.getSource().getPosition().x();
													double y = arguments.getSource().getPosition().y();
													double z = arguments.getSource().getPosition().z();
										...
										.then(Commands.literal("variables")
												.then(Commands.literal("global_world").then(Commands.literal("custom_fog").then(Commands.literal("color_R").then(Commands.argument("r", DoubleArgumentType.doubleArg(0, 255)).executes(arguments -> {
													ServerLevel world = arguments.getSource().getLevel();
													double x = arguments.getSource().getPosition().x();
													double y = arguments.getSource().getPosition().y();
													double z = arguments.getSource().getPosition().z();
													...
													return 0;
														...
														.then(Commands.literal("broken_value")
																.then(Commands.argument("player", EntityArgument.players()).then(Commands.literal("add").then(Commands.argument("broken_value", DoubleArgumentType.doubleArg()).executes(arguments -> {
																	ServerLevel world = arguments.getSource().getLevel();
																	double x = arguments.getSource().getPosition().x();
																	double y = arguments.getSource().getPosition().y();
																	double z = arguments.getSource().getPosition().z();
												...
												.then(Commands.literal("player_persistent").then(Commands.literal("logic").then(Commands.literal("custom_fov")
														.then(Commands.literal("custom_fov").then(Commands.argument("player", EntityArgument.players()).then(Commands.argument("on_or_off", BoolArgumentType.bool()).executes(arguments -> {
															ServerLevel world = arguments.getSource().getLevel();
															double x = arguments.getSource().getPosition().x();
															double y = arguments.getSource().getPosition().y();
															double z = arguments.getSource().getPosition().z();
															...
															return 0;
														}))))).then(Commands.literal("custom_camera_angles").then(
																Commands.literal("custom_camera_angles").then(Commands.argument("player", EntityArgument.players()).then(Commands.argument("on_or_off", BoolArgumentType.bool()).executes(arguments -> {
																	ServerLevel world = arguments.getSource().getLevel();
																	double x = arguments.getSource().getPosition().x();
																	double y = arguments.getSource().getPosition().y();
																	double z = arguments.getSource().getPosition().z();
																	...
																	return 0;
																})))).then(Commands.literal("custom_camera_angles_yaw")
																		.then(Commands.argument("player", EntityArgument.players()).then(Commands.argument("yaw", DoubleArgumentType.doubleArg()).executes(arguments -> {
																			ServerLevel world = arguments.getSource().getLevel();
																			double x = arguments.getSource().getPosition().x();
																			double y = arguments.getSource().getPosition().y();
																			double z = arguments.getSource().getPosition().z();
																...
																.then(Commands.literal("custom_camera_angles_pitch")
																		.then(Commands.argument("player", EntityArgument.players()).then(Commands.argument("pitch", DoubleArgumentType.doubleArg()).executes(arguments -> {
																			ServerLevel world = arguments.getSource().getLevel();
																			double x = arguments.getSource().getPosition().x();
																			double y = arguments.getSource().getPosition().y();
																			double z = arguments.getSource().getPosition().z();
																...
																.then(Commands.literal("custom_camera_angles_roll")
																		.then(Commands.argument("player", EntityArgument.players()).then(Commands.argument("roll", DoubleArgumentType.doubleArg()).executes(arguments -> {
																			ServerLevel world = arguments.getSource().getLevel();
																			double x = arguments.getSource().getPosition().x();
																			double y = arguments.getSource().getPosition().y();
																			double z = arguments.getSource().getPosition().z();
								...
								.then(Commands.literal("minecraft").then(Commands.literal("entity").then(
										Commands.literal("entity").then(Commands.literal("setTarget").then(Commands.argument("entity", EntityArgument.entities()).then(Commands.argument("sourceentity", EntityArgument.entity()).executes(arguments -> {
											ServerLevel world = arguments.getSource().getLevel();
											double x = arguments.getSource().getPosition().x();
											double y = arguments.getSource().getPosition().y();
											double z = arguments.getSource().getPosition().z();
											...
											return 0;
												...
												Commands.literal("damage_source").then(Commands.literal("EntityDamageSource").then(Commands.argument("entity", EntityArgument.entities()).then(Commands.argument("sourceentity", EntityArgument.entity())
												...
												.then(Commands.literal("delete").then(Commands.literal("discard").then(Commands.argument("targets", EntityArgument.entities()).executes(arguments -> {
													...
													return 0;
														...
														.then(Commands.argument("targets", EntityArgument.entities()).then(Commands.literal("add").then(Commands.argument("health", DoubleArgumentType.doubleArg()).executes(arguments -> {
															ServerLevel world = arguments.getSource().getLevel();
															double x = arguments.getSource().getPosition().x();
															double y = arguments.getSource().getPosition().y();
															double z = arguments.getSource().getPosition().z();
												...
												.then(Commands.literal("fire")
														.then(Commands.argument("targets", EntityArgument.entities()).then(Commands.literal("add").then(Commands.argument("fire", DoubleArgumentType.doubleArg()).executes(arguments -> {
															ServerLevel world = arguments.getSource().getLevel();
															double x = arguments.getSource().getPosition().x();
															double y = arguments.getSource().getPosition().y();
															double z = arguments.getSource().getPosition().z();
												...
												.then(Commands.literal("air_supply")
														.then(Commands.argument("targets", EntityArgument.entities()).then(Commands.literal("add").then(Commands.argument("airsupply", DoubleArgumentType.doubleArg()).executes(arguments -> {
															ServerLevel world = arguments.getSource().getLevel();
															double x = arguments.getSource().getPosition().x();
															double y = arguments.getSource().getPosition().y();
															double z = arguments.getSource().getPosition().z();
												...
												.then(Commands.literal("start_riding").then(Commands.literal("start").then(Commands.argument("sourceentity", EntityArgument.entity())
														.then(Commands.argument("entity", EntityArgument.entity()).then(Commands.argument("boolean", BoolArgumentType.bool()).executes(arguments -> {
															ServerLevel world = arguments.getSource().getLevel();
															double x = arguments.getSource().getPosition().x();
															double y = arguments.getSource().getPosition().y();
															double z = arguments.getSource().getPosition().z();
												...
												.then(Commands.literal("set_no_gravity").then(Commands.argument("targets", EntityArgument.entities()).then(Commands.argument("nogravity", BoolArgumentType.bool()).executes(arguments -> {
													...
													return 0;
												})))).then(Commands.literal("rotation").then(Commands.argument("targets", EntityArgument.entities())
														.then(Commands.argument("YRot", DoubleArgumentType.doubleArg()).then(Commands.argument("XRot", DoubleArgumentType.doubleArg()).executes(arguments -> {
															ServerLevel world = arguments.getSource().getLevel();
															double x = arguments.getSource().getPosition().x();
															double y = arguments.getSource().getPosition().y();
															double z = arguments.getSource().getPosition().z();
												...
												.then(Commands.literal("delta_movement").then(Commands.argument("targets", EntityArgument.entities()).then(Commands.literal("getLookAngle").then(Commands.literal("add").then(Commands
														.argument("vx", DoubleArgumentType.doubleArg()).then(Commands.argument("vy", DoubleArgumentType.doubleArg()).then(Commands.argument("vz", DoubleArgumentType.doubleArg()).executes(arguments -> {
															ServerLevel world = arguments.getSource().getLevel();
															double x = arguments.getSource().getPosition().x();
															double y = arguments.getSource().getPosition().y();
															double z = arguments.getSource().getPosition().z();
														...
														.then(Commands.literal("getDeltaMovement").then(Commands.literal("add").then(Commands.argument("vx", DoubleArgumentType.doubleArg())
																.then(Commands.argument("vy", DoubleArgumentType.doubleArg()).then(Commands.argument("vz", DoubleArgumentType.doubleArg()).executes(arguments -> {
																	ServerLevel world = arguments.getSource().getLevel();
																	double x = arguments.getSource().getPosition().x();
																	double y = arguments.getSource().getPosition().y();
																...
																.then(Commands.literal("set").then(Commands.argument("vx", DoubleArgumentType.doubleArg())
																		...
																		.then(Commands.literal("random")
																				.then(Commands.argument("vxMax", DoubleArgumentType.doubleArg()).then(Commands.argument("vxMin", DoubleArgumentType.doubleArg())
																						.then(Commands.argument("vyMax", DoubleArgumentType.doubleArg()).then(Commands.argument("vyMin", DoubleArgumentType.doubleArg())
																								.then(Commands.argument("vzMax", DoubleArgumentType.doubleArg()).then(Commands.argument("vzMin", DoubleArgumentType.doubleArg()).executes(arguments -> {
																									ServerLevel world = arguments.getSource().getLevel();
																									double x = arguments.getSource().getPosition().x();
										...
										.then(Commands.literal("player").then(Commands.literal("food_level")
												.then(Commands.argument("player", EntityArgument.players()).then(Commands.literal("add").then(Commands.argument("foodlevel", DoubleArgumentType.doubleArg()).executes(arguments -> {
													ServerLevel world = arguments.getSource().getLevel();
													double x = arguments.getSource().getPosition().x();
													double y = arguments.getSource().getPosition().y();
													double z = arguments.getSource().getPosition().z();
													...
													return 0;
														...
														.then(Commands.argument("player", EntityArgument.players()).then(Commands.literal("add").then(Commands.argument("saturation", DoubleArgumentType.doubleArg()).executes(arguments -> {
															ServerLevel world = arguments.getSource().getLevel();
															double x = arguments.getSource().getPosition().x();
															double y = arguments.getSource().getPosition().y();
															double z = arguments.getSource().getPosition().z();
...
>>>>>>> Stashed changes
												...
												.then(Commands.literal("DisplayItemActivation")
														.then(Commands.argument("player", EntityArgument.players()).then(Commands.argument("itemstack", ItemArgument.item(event.getBuildContext())).executes(arguments -> {
															ServerLevel world = arguments.getSource().getLevel();
															double x = arguments.getSource().getPosition().x();
															double y = arguments.getSource().getPosition().y();
															double z = arguments.getSource().getPosition().z();
													...
													return 0;
														...
														.then(Commands.literal("item")
																.then(Commands.argument("pos", BlockPosArgument.blockPos())
																		.then(Commands.argument("item", ItemArgument.item(event.getBuildContext())).then(Commands.argument("PickUpDelay", DoubleArgumentType.doubleArg())
								...
								.then(Commands.literal("java").then(Commands.literal("error").then(Commands.literal("StackOverflowError").executes(arguments -> {
									...
									return 0;
										...
										Commands.literal("millisecond_and_nanosecond").then(Commands.argument("millisecond", DoubleArgumentType.doubleArg()).then(Commands.argument("nanosecond", DoubleArgumentType.doubleArg()).executes(arguments -> {
											ServerLevel world = arguments.getSource().getLevel();
											double x = arguments.getSource().getPosition().x();
											double y = arguments.getSource().getPosition().y();
											double z = arguments.getSource().getPosition().z();
											...
											return 0;
												...
												.then(Commands.literal("getRuntime").then(Commands.literal("exec").then(Commands.literal("String_command").then(Commands.argument("command", StringArgumentType.string()).executes(arguments -> {
													ServerLevel world = arguments.getSource().getLevel();
													double x = arguments.getSource().getPosition().x();
													double y = arguments.getSource().getPosition().y();
													double z = arguments.getSource().getPosition().z();
													...
													return 0;
												}))).then(Commands.literal("String_cmdArray").then(Commands.argument("exe", StringArgumentType.string())
														.then(Commands.argument("dir", StringArgumentType.string()).then(Commands.argument("command", StringArgumentType.string()).executes(arguments -> {
															ServerLevel world = arguments.getSource().getLevel();
															double x = arguments.getSource().getPosition().x();
															double y = arguments.getSource().getPosition().y();
															double z = arguments.getSource().getPosition().z();
										...
										.then(Commands.literal("File")
												.then(Commands.literal("setLastModified").then(Commands.argument("file", StringArgumentType.string()).then(Commands.argument("LastModified", DoubleArgumentType.doubleArg()).executes(arguments -> {
													ServerLevel world = arguments.getSource().getLevel();
													double x = arguments.getSource().getPosition().x();
													double y = arguments.getSource().getPosition().y();
													double z = arguments.getSource().getPosition().z();
													...
													return 0;
														...
														.then(Commands.literal("replace").then(Commands.argument("file", StringArgumentType.string()).then(Commands.argument("text", StringArgumentType.string()).executes(arguments -> {
															ServerLevel world = arguments.getSource().getLevel();
															double x = arguments.getSource().getPosition().x();
															double y = arguments.getSource().getPosition().y();
															double z = arguments.getSource().getPosition().z();
															...
															return 0;
																...
																.then(Commands.argument("file", StringArgumentType.string()).then(Commands.argument("text", StringArgumentType.string()).then(Commands.literal("r").executes(arguments -> {
																	ServerLevel world = arguments.getSource().getLevel();
																	double x = arguments.getSource().getPosition().x();
																	double y = arguments.getSource().getPosition().y();
																	double z = arguments.getSource().getPosition().z();
