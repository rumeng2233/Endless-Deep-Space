...
public class GravityArrow extends CommonArrow {
	...
	public GravityArrow(EntityType<? extends GravityArrow> type, Level worldIn) {
		super(type, worldIn);
	}

	public GravityArrow(EntityType<? extends GravityArrow> type, Level worldIn, Entity shooter) {
		super(type, worldIn);
