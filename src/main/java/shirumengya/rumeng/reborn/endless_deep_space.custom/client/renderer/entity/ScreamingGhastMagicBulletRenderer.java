...
@OnlyIn(Dist.CLIENT)
public class ScreamingGhastMagicBulletRenderer extends EntityRenderer<ScreamingGhastMagicBullet> {
   private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation("endless_deep_space.custom:textures/entity/projectile/ender_dragon_wind_bomb.png");
   private static final RenderType RENDER_TYPE = RenderType.entityCutoutNoCull(TEXTURE_LOCATION);

   public ScreamingGhastMagicBulletRenderer(EntityRendererProvider.Context p_173962_) {
      super(p_173962_);
   }

   protected int getBlockLightLevel(ScreamingGhastMagicBullet p_114087_, BlockPos p_114088_) {
      return 15;
   }

   public void render(ScreamingGhastMagicBullet p_114080_, float p_114081_, float p_114082_, PoseStack p_114083_, MultiBufferSource p_114084_, int p_114085_) {
      p_114083_.pushPose();
   ...
   public ResourceLocation getTextureLocation(ScreamingGhastMagicBullet p_114078_) {
