...
@OnlyIn(Dist.CLIENT)
public class EnderDragonWindBombRenderer extends EntityRenderer<EnderDragonWindBomb> {
   ...
   public EnderDragonWindBombRenderer(EntityRendererProvider.Context p_173962_) {
      super(p_173962_);
   }

   protected int getBlockLightLevel(EnderDragonWindBomb p_114087_, BlockPos p_114088_) {
      return 15;
   }

   public void render(EnderDragonWindBomb p_114080_, float p_114081_, float p_114082_, PoseStack p_114083_, MultiBufferSource p_114084_, int p_114085_) {
      p_114083_.pushPose();
      p_114083_.scale(14.0F, 14.0F, 14.0F);
   ...
   public ResourceLocation getTextureLocation(EnderDragonWindBomb p_114078_) {
