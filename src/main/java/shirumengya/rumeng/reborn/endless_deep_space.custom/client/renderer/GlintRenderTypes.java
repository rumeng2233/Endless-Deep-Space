...
public class GlintRenderTypes extends RenderType {
	...
	private static List<RenderType> newRenderList(Function<String, RenderType> func) {
		ArrayList<RenderType> list = new ArrayList<>(17 + 1);
		list.add(func.apply("test"));
		return list;
	}
	...
	private static ResourceLocation texture(String name) {
		return new ResourceLocation(EndlessDeepSpaceMod.MODID, "textures/glint/" + name + "_glint.png");
	}
}
