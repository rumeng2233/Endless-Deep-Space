...
@OnlyIn(Dist.CLIENT)
public class ChestCultRenderer implements BlockEntityRenderer<BarrelBlockEntity> {
   ...
   public ChestCultRenderer(BlockEntityRendererProvider.Context p_173689_) {
   }

   public void render(BarrelBlockEntity p_112650_, float p_112651_, PoseStack p_112652_, MultiBufferSource p_112653_, int p_112654_, int p_112655_) {
      Matrix4f matrix4f = p_112652_.last().pose();
      this.renderCube(p_112650_, matrix4f, p_112653_.getBuffer(this.renderType()));
   }

   private void renderCube(BarrelBlockEntity p_173691_, Matrix4f p_173692_, VertexConsumer p_173693_) {
   ...
   private void renderFace(BarrelBlockEntity p_173695_, Matrix4f p_173696_, VertexConsumer p_173697_, float p_173698_, float p_173699_, float p_173700_, float p_173701_, float p_173702_, float p_173703_, float p_173704_, float p_173705_, Direction p_173706_) {
