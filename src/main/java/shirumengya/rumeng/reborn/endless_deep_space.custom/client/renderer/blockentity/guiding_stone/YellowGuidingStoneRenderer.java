...
import shirumengya.rumeng.reborn.endless_deep_space.custom.block.block_entity.guiding_stone.YellowGuidingStoneBlockEntity;
...
@OnlyIn(Dist.CLIENT)
public class YellowGuidingStoneRenderer implements BlockEntityRenderer<YellowGuidingStoneBlockEntity> {
   private static final ResourceLocation BEAM_LOCATION = new ResourceLocation("textures/entity/guiding_stone_beam.png");

   public YellowGuidingStoneRenderer(BlockEntityRendererProvider.Context p_173683_) {
   }

   public void render(YellowGuidingStoneBlockEntity p_112613_, float p_112614_, PoseStack p_112615_, MultiBufferSource p_112616_, int p_112617_, int p_112618_) {
...
//         double d0 = p_112613_.isSpawning() ? (double)p_112613_.getLevel().getMaxBuildHeight() : 50.0D;
         ...
         float[] afloat = DyeColor.YELLOW.getTextureDiffuseColors();
...
//   }
	...
	protected float getOffsetUp() {
      ...
      return 0.0F;
   	...
   	public boolean shouldRenderOffScreen(YellowGuidingStoneBlockEntity p_112138_) {
      return true;
   }
      ...
      return (int)EndlessDeepSpaceModClientConfig.GUIDING_STONE_RENDERING_DISTANCE.get();
   	...
   	public boolean shouldRender(YellowGuidingStoneBlockEntity p_173531_, Vec3 p_173532_) {
