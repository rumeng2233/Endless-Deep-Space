...
import shirumengya.rumeng.reborn.endless_deep_space.custom.block.block_entity.guiding_stone.SkyBlueGuidingStoneBlockEntity;
...
@OnlyIn(Dist.CLIENT)
public class SkyBlueGuidingStoneRenderer implements BlockEntityRenderer<SkyBlueGuidingStoneBlockEntity> {
   private static final ResourceLocation BEAM_LOCATION = new ResourceLocation("textures/entity/guiding_stone_beam.png");

   public SkyBlueGuidingStoneRenderer(BlockEntityRendererProvider.Context p_173683_) {
   }

   public void render(SkyBlueGuidingStoneBlockEntity p_112613_, float p_112614_, PoseStack p_112615_, MultiBufferSource p_112616_, int p_112617_, int p_112618_) {
...
//   }
	...
	protected float getOffsetUp() {
      ...
      return 0.0F;
   	...
   	public boolean shouldRenderOffScreen(SkyBlueGuidingStoneBlockEntity p_112138_) {
      return true;
   }
      ...
      return (int)EndlessDeepSpaceModClientConfig.GUIDING_STONE_RENDERING_DISTANCE.get();
   	...
   	public boolean shouldRender(SkyBlueGuidingStoneBlockEntity p_173531_, Vec3 p_173532_) {
