...
=======
        ...
        event.registerEntityRenderer(ProjectileInit.GRAVITY_ARROW.get(), DefaultArrowRenderer::new);
        event.registerEntityRenderer(ProjectileInit.ANTIGRAVITY_ARROW.get(), DefaultArrowRenderer::new);
>>>>>>> Stashed changes
	}
}
